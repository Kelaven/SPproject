...
function ballFollowsMouse(event) {
    ...
    const elements = document.querySelectorAll('.div1, .div2, .div3, .carousel-inner, .navbar, .h1__scramble, button, .container__form--ball'); // select divs to change the ball's design
