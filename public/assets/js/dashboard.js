...
function openPopup(event) {
    ...
    const confirmDelete = window.confirm('Êtes-vous sûr de vouloir supprimer cette donnée ? Cette action est irréversible !'); // The window object is the global object in the browser where global methods like confirm() reside.
