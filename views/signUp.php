                    ...
                    <div class="row w-100 justify-content-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group pe-xl-3 ps-xl-3 px-1">
                                ...
                                <input required type="password" name="password" id="password" placeholder="Mot de passe" minlength="8" maxlength="30" class="field__rsz form-control password__inputs" value="<?= $password ?? '' ?>" pattern="<?= REGEX_PASSWORD ?>">
