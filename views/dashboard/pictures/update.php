                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="post" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-group pb-5">
                                ...
                                <textarea class="form__inputs" id="description" name="description" rows="4" placeholder="Ajoutez une description..."><?php if (empty($result) || !isset($result)) { echo($picture->description) ?? ''; } ?></textarea>
