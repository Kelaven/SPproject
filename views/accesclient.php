...
<section class="container">
    <div class="row justify-content-center">
        <div class="px-0 px-md-3 px-lg-5 py-3 pt-5 col-11 col-md-6 col-xl-4">
            <a class="accesclient__a" href="/../controllers/accesclientformpersonalized-ctrl/accesclientformanais-ctrl.php" target="_blank">
                ...
                <div>
                    <p class="text-center"><i class="fa-solid fa-lock pe-2 pt-3"></i>Anaïs</p>
                </div>
            </a>
        </div>
        <div class="px-0 px-md-3 px-lg-5 py-3 pt-5 col-11 col-md-6 col-xl-4">
            <a class="accesclient__a" href="/../controllers/accesclientformpersonalized-ctrl/accesclientformpauline-ctrl.php" target="_blank">
                ...
                <div>
                    <p class="text-center"><i class="fa-solid fa-lock pe-2 pt-3"></i>Pauline</p>
                </div>
            </a>
        </div>
        <div class="px-0 px-md-3 px-lg-5 py-3 pt-5 col-11 col-md-6 col-xl-4">
            <a class="accesclient__a" href="/../controllers/accesclientformpersonalized-ctrl/accesclientformjad-ctrl.php" target="_blank">
                ...
                <div>
                    <p class="text-center"><i class="fa-solid fa-lock pe-2 pt-3"></i>Jad</p>
                </div>
            </a>
        </div>
        <div class="px-0 px-md-3 px-lg-5 py-3 pb-5 col-11 col-md-6 col-xl-4">
            <a class="accesclient__a" href="/../controllers/accesclientformpersonalized-ctrl/accesclientformmelissa-ctrl.php" target="_blank">
                ...
                <div>
                    <p class="text-center"><i class="fa-solid fa-lock pe-2 pt-3"></i>Mélissa</p>
                </div>
            </a>
        </div>
        <div class="px-0 px-md-3 px-lg-5 py-3 pb-5 col-11 col-md-6 col-xl-4">
            <a class="accesclient__a" href="/../controllers/accesclientformpersonalized-ctrl/accesclientformromain-ctrl.php" target="_blank">
                ...
                <div>
                    <p class="text-center"><i class="fa-solid fa-lock pe-2 pt-3"></i>Romain</p>
                </div>
            </a>
        </div>
        <div class="px-0 px-md-3 px-lg-5 py-3 pb-5 col-11 col-md-6 col-xl-4">
            <a class="accesclient__a" href="/../controllers/accesclientformpersonalized-ctrl/accesclientformantoine-ctrl.php" target="_blank">
                ...
                <div>
                    <p class="text-center"><i class="fa-solid fa-lock pe-2 pt-3"></i>Antoine</p>
                </div>
            </a>
        </div>
    </div>
